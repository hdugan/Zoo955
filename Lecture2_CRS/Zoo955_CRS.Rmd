...
mendota_WGS84 <- spTransform(mendota, CRS("+proj=longlat +datum=NAD83 +no_defs +ellps=GRS80 +towgs84=0,0,0")) #longer method, but sometimes easier
```
...
You can see the data extent is now `297862.2, 307362.5, 4771864, 4779978 (xmin, xmax, ymin, ymax)`. UTM units are in meters, rather than degrees, which makes arithmetic calculations much easier. Here we can tell that Mendota is about 9550 m across (307362.5 - 297862.2)
...
# Homework
What's the best way to check that CRS of two objects are identical? 

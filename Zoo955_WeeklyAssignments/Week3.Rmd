...
`st_simplify` = is a way to scale down the sizes of vector polygons, usually for the production of smaller maps or to conserve memory and disk space, which is especially useful for interactive maps. It reduces the number of vertices in the polygon
